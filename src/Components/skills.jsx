    ...
    <div className="text-center mx-auto mt-20">
      ...
      <div className="flex flex-wrap justify-center items-center mt-12 mx-auto">
        {techLinks.map((item, index) => (
          <div
            key={index}
            className="md:w-44 md:h-44 w-32 h-32 flex flex-col justify-center items-center bg-white shadow-md rounded-md border-4 border-black transition-custom hover:bg-black group m-2 p-4"
          >
            <div className="md:mb-4 ">
              <i
                className={`${item.icon} md:text-6xl text-4xl text-black group-hover:text-white`}
              ></i>
            </div>
