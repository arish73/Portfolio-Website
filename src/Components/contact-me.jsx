...
const ContactMe = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="flex m-10 md:flex-row  flex-col items-center justify-center">
        {/* Form div */}
      ...
      hover:bg-white hover:text-black focus:outline-none focus:ring-7 focus:ring-blue-600 focus:ring-opacity-50 hover:ring-2 hover:ring-black transition duration-300"
              ...
              <div className="socials flex flex-row space-x-5 ">
                <a
                  href="https://github.com/arish73"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 flex items-center justify-center text-4xl border-2 p-2 border-black rounded-lg hover:bg-black hover:text-white transition duration-300"
                >
                ...
                <a
                  href="mailto:izhar.arish@gmail.com"
                  className="w-12 h-12 flex items-center justify-center text-4xl border-2 p-2 border-black rounded-lg hover:bg-black hover:text-white transition duration-300"
                >
        ...
        <div className="container mx-auto items-center justify-center">
          <div>
            <h1 className="text-4xl font-bold m-10">
              Got a project or role in mind? Let's{" "}
              <span
                className="font-extrabold font-mono outline-text text5xl
        "
              >
                connect!
              </span>
            </h1>
            <h1 className=" text-3xl font-semibold m-10 font-mono break-words overflow-wrap-break-word">
              izhar.arish@gmail.com
            </h1>
          </div>
        </div>
      </div>
      {/* Footer */}
      <div className="bg-black flex-col sm:flex-row flex items-end  sm:justify-between text-white p-2 sm:p-4">
        <div className="flex-1">
          <h1 className="alex-brush-regular font-bold">Arish Izhar</h1>
        </div>
        <div className="flex flex-col items-end space-y-1 font-mono max-w-full">
          <div className="text-right">
            <h1 className="text-right">
              Loosely designed in Figma & deployed via netlify
            </h1>
          </div>
          <div>
            <h1 className="text-right">Built using React & Tailwind CSS</h1>
          </div>
        </div>
      </div>
    </div>
